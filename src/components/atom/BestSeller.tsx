  ...
  return (
   <section className="bestseller">
    <h3>Explorez nos  produits</h3>
      ...
      <Link to="/Shop"><div className="item"><img src="/img/freepik__the-style-is-candid-image-photography-with-natural__12545.jpeg" alt="Matelas img" title="click" /> <span>Matelas</span></div></Link>
